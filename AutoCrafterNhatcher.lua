...
do
    ...
    --                         Configuration & State
    --================================================================================--
    FarmModule.CONFIG_FILE_NAME = "CombinedFarmAndSeller_v14_Fixed.json"
    ...
    function FarmModule:CreateGUI()
        ...
        local subMenus = {}
        for categoryName, petList in pairs(self.UniquePetCategoryData) do
        ...
        for categoryName, _ in pairs(self.UniquePetCategoryData) do
